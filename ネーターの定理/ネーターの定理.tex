            ...
            (   Q.このとき, $i_{*}Y \in T_{(\bar{q}, \bar{p})(T \mathbb{S}^n)}$より
                ...
                \[
                        ...
                        \begin{bmatrix}
                            -q \\
                            p
                        \end{bmatrix}\right\} \subset T_{(\bar{q}, \bar{p})}(T \mathbb{S}^n)
                \]
                となるのでは?
                )
            したがって, ハミルトンベクトル場$X_{\hat{f}}$は次の$\mathbb{R}^{2(n+1)}$上のベクトル場の$T^{+} \mathbb{S}^{n}$への制限である:
            \[
                \tilde{X}_{f} = \langle \nabla_p f,  \left(\frac{\partial}{\partial \bar{q}}\right)\rangle - \langle \nabla_q f,  \left(\frac{\partial}{\partial \bar{p}}\right)\rangle + \langle \frac{\partial f}{\partial \bar{p}},  \Gamma \left(\frac{\partial}{\partial \bar{p}}\right)\rangle.
            \]
            ただし, $\nabla$は共変微分, $\Gamma$は回転の生成子である:
            \[
                \nabla_{\bar{p}} f = \frac{\partial f}{\partial \bar{p}} - \langle \frac{\partial f}{\partial \bar{p}}, \bar{q} \rangle \bar{q}, \ \nabla_{\bar{q}} f = \frac{\partial f}{\partial \bar{q}} - \langle \frac{\partial f}{\partial \bar{q}}, \bar{q} \rangle \bar{q}, \ \left(\Gamma \left(\frac{\partial}{\partial p}\right) \right)_{i} = \sum_{j} (q_i p_j - p_i q_j) \frac{\partial}{\partial p_j}.
            \]
            \red{TO DO: この式の導出を行う}
            \vskip \baselineskip
